...
{
	public class TaskTypeSecurityProvider: AbstractModuleSecurityConstraintsProvider<TaskTypeModel>
	{
		public TaskTypeSecurityProvider(IFilteringService filteringService) : base(filteringService)
		{
		}
